...
@section('title') | New URL @endsection
    ...
    <div class="well well-sm well-url">
        <div class="input-group input-group-lg">
            ...
            <span class="input-group-btn">
                <button class="btn btn-warning" data-toggle="tooltip" type="button" id="btn-copy-url" data-clipboard-target="#input-url" title="Copied!">Copy!</button>
            </span>
        </div>
    </div>
